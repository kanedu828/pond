import { TextInput, Text, Alert, Box, Button, Group, PasswordInput } from "@mantine/core";
...
export const Profile = (props: ProfileProps) => {
    ...
    return (
        <ModalContainer isOpen={props.isOpen} close={props.close} isLoading={isLoading} title='Profile'>
           <TextInput disabled label={
            ...
            <Text fw={700} c="pondTeal.9">
                You are currently logged in as a guest. You can link your account here!
            </Text>
            {!user?.isAccount && 
            <Box w="15%">
            {error !== "" && (
